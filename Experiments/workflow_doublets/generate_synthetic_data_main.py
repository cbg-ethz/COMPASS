...
if __name__=="__main__":
    ...
    generate_data(args.o,n_nodes=args.nnodes,n_cells=args.ncells,n_regions=args.nregions,n_SNVs=args.nSNVs,n_CNVs=args.nCNVs,n_CNLOHs=args.nCNLOHs,nodeprobs_concentration=args.nodeprobconcentration,\
        dropout_rate_avg=0.06,dropout_rate_sigma=args.dropoutsigma,seed=args.seed,sequencing_depth=args.depth,theta=args.theta,regionprob_sigma=args.regionprobsigma,doublet_rate=args.doublet,method=args.m)
...
df = pd.read_csv("COMPASS/Experiments/workflow_BITSC2/results_BITSC2_merged.csv")
df = df[df["nodes"]==6]
df = df[df["SNVs"]==12]
df = df[df["CNVs"]==3]
...
plt.savefig("Comparison_BITSC2_200cells.png",dpi=500,bbox_inches="tight",pad_inches=0.1)